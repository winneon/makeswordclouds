...
class Utils:
	...
	def make_cloud(self, text):
		...
		cloud = WordCloud(font_path = 'bot/fonts/' + random.choice(os.listdir('bot/fonts/')), background_color = 'rgb(25, 25, 25)', width = 1280, height = 720, scale = 1, color_func = self.light_colour_func)
		cloud.generate(text)
